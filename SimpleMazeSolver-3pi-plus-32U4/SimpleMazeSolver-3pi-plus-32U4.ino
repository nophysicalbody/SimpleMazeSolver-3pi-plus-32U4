...
uint16_t maxSpeeds[12] =        {130,  130,  130,   120,    130,   130,   120,  120,  120,  120,  120,  120}; // X1
uint16_t turnSpeeds[12] =       {95,   100,  100,   100,    95,    95,    95,   95,   100,  95,   95,   100}; // X2
uint16_t angintSpeeds[12] =     {61,   58,   58,    58,     61,    59,    59,   61,   61,   59,   61,   59}; // X3
uint16_t angintDelays[12] =     {40,   37.5, 37.5,  40,     40,    40,    40,   37.5, 37.5, 40,   40,   40}; // X4
uint16_t interSpeeds[12] =      {37.5, 37.5, 35,    35,     35,    37.5,  37.5, 35,   37.5, 37.5, 35,   35}; // X5
uint16_t interDelays[12] =      {95,   90,   90,    95,     95,    95,    90,   90,   95,   90,   95,   90}; // X6
uint16_t turnDelays[12] =       {200,  200,  200,   202.5,  200,   200,   200,  202.5,200,  200,  202.5,200}; // X7
uint16_t llbrakeoneSpeeds[12] = {70,   70,   70,    80,     70,    80,    70,   80,   80,   70,   70,   80}; // X8
uint16_t llbrakeoneDelays[12] = {42.5, 37.5, 37.5,  42.5,   37.5,  42.5,  37.5, 37.5, 37.5, 42.5, 42.5, 37.5}; // X9
