...
#define I_GAIN 0.00
#define D_GAIN 0.00
#define FEEDFWD_GAIN (400.0 / 1500.0) // Approximates ideal value by assuming full motor command of 400 corresponds to full linear velocity output of 1500 mm/s
...
const int16_t test_low_duration_ms = 100;
const int16_t test_high_duration_ms = 400;
